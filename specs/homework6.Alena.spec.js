...
describe('Функция #2 возвращает сумму всех баллов', () => {
    /**
    * Описываем несколько unit тестов для функции,
    * которая проверяет, что она существует и работает корректно. #2
    */
    const scores2 = {
        Anna: 10,
        Olga: 1,
    ...
    /** Проверяем функция #2 работает корректно (positive tests) #2*/
    ...
    /** Проверяем функция #1 определяет невалидную сумму баллов (negative tests) #2*/
